...
const statistics = ref(props.scheduler.getStatistics(props.cards))
const refreshStatistics = () => {
  statistics.value = props.scheduler.getStatistics(props.cards)
}

const handleStartReview = () => {
  props.scheduler.initialise(props.cards)
  props.scheduler.addNewCardsToSession(additionalNewCards.value)
  emit('start')
}
  ...
  <div class="h-full w-full flex">
    <div class="m-auto py-8 px-4 w-full max-w-sm">
      <div class="flex flex-col items-center w-full">
        ...
        <RoundedContainer class="mt-8 w-full">
          <div class="flex flex-col w-full">
            <div class="w-full flex items-center">
              ...
              <span class="ml-auto mr-8 font-light dark:text-white">{{ statistics.due.seen }}</span>
        ...
        <Button class="mt-10 w-full" :disabled="totalCardsToReview == 0" @click="handleStartReview"
          >Start</Button
        >
      </div>
    </div>
